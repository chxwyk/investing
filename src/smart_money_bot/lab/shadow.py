...
# --- GMGN families (v2.45, section 64) ---------------------------------------
# These ride the same Trending bankroll and are separated by *attribution*.  A
# separate $100 book per provider would take far longer to reach a readable
# sample and would not answer the question that matters, which is whether a GMGN
# label adds anything on top of the evidence we already had.
#
# They are deliberately fine-grained: "GMGN said something" is not a hypothesis.
# "A GMGN smart-money tag beats no tag" is, and so is "a KOL tag does not".
FAMILY_GMGN_TRENDING = "GMGN_TRENDING"
FAMILY_GMGN_TRENCH_NEW = "GMGN_TRENCH_NEW"
FAMILY_GMGN_TRENCH_FINAL_STRETCH = "GMGN_TRENCH_FINAL_STRETCH"
FAMILY_GMGN_TRENCH_MIGRATED = "GMGN_TRENCH_MIGRATED"
FAMILY_GMGN_SMART_MONEY = "GMGN_SMART_MONEY"
FAMILY_GMGN_KOL = "GMGN_KOL"
FAMILY_GMGN_MARKET_SIGNAL = "GMGN_MARKET_SIGNAL"
FAMILY_GMGN_HOT_SEARCH = "GMGN_HOT_SEARCH"
FAMILY_GMGN_HOLDER_EXPANSION = "GMGN_HOLDER_EXPANSION"
FAMILY_GMGN_TOP_TRADER_ACCUMULATION = "GMGN_TOP_TRADER_ACCUMULATION"
FAMILY_GMGN_STORY = "GMGN_STORY"
FAMILY_GMGN_THESIS = "GMGN_THESIS"
FAMILY_GMGN_CONFLUENCE = "GMGN_CONFLUENCE"

#: Every GMGN-attributed family, so provider diversity can be measured apart
#: from evidence diversity (section 58): three GMGN families agreeing is one
#: provider agreeing with itself.
GMGN_FAMILIES: tuple[str, ...] = (
    ...
    FAMILY_GMGN_HOLDER_EXPANSION,
    FAMILY_GMGN_TOP_TRADER_ACCUMULATION,
    FAMILY_GMGN_STORY,
    FAMILY_GMGN_THESIS,
    FAMILY_GMGN_CONFLUENCE,
)
...
FAMILY_LABELS: dict[str, str] = {
    FAMILY_GMGN_TRENDING: "GMGN TRENDING",
    FAMILY_GMGN_TRENCH_NEW: "GMGN TRENCH NEW",
    FAMILY_GMGN_TRENCH_FINAL_STRETCH: "GMGN TRENCH FINAL STRETCH",
    FAMILY_GMGN_TRENCH_MIGRATED: "GMGN TRENCH MIGRATED",
    FAMILY_GMGN_SMART_MONEY: "GMGN SMART MONEY",
    FAMILY_GMGN_KOL: "GMGN KOL",
    FAMILY_GMGN_MARKET_SIGNAL: "GMGN MARKET SIGNAL",
    FAMILY_GMGN_HOT_SEARCH: "GMGN HOT SEARCH",
    FAMILY_GMGN_HOLDER_EXPANSION: "GMGN HOLDER EXPANSION",
    FAMILY_GMGN_TOP_TRADER_ACCUMULATION: "GMGN TOP TRADER ACCUMULATION",
    FAMILY_GMGN_STORY: "GMGN STORY",
    FAMILY_GMGN_THESIS: "GMGN THESIS",
    FAMILY_GMGN_CONFLUENCE: "GMGN CONFLUENCE",
